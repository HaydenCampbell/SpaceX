package com.haydencampbell.spacex.android
...
class SpaceXRecyclerViewAdapter(var launches: List<RocketLaunch>) : RecyclerView.Adapter<SpaceXRecyclerViewAdapter.LaunchViewHolder>() {
